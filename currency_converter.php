...
<body>
    ...
    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class="container">
            ...
            <div class="buttondiv">
                <a href="http://localhost/CurrencyConverter/login.php" class="button1">SignIn</a>
                <a href="http://localhost/CurrencyConverter/signup_form.php" class="button2">SignUp</a>
            </div><br>
